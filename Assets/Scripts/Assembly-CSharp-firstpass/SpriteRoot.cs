...
//					UnityEngine.Object.Destroy(oldMesh);
	...
	public void CalcPixelToUV()
	{
		...
		else if (GetComponent<Renderer>() != null && GetComponent<Renderer>().sharedMaterial != null && GetComponent<Renderer>().sharedMaterial.mainTexture != null)
		{
	...
	public virtual void SetCamera(Camera c)
	{
		...
		if (!Application.isPlaying)
		{
			if ((screenSize.x == 0f || c != renderCamera) && c.pixelHeight > 100)
			{
