...
public class UIButton : AutoSpriteControlBase
{
	...
	public override void OnInput(ref POINTER_INFO ptr)
	{
		...
		case POINTER_INFO.INPUT_EVENT.TAP:
			if (ptr.type != POINTER_INFO.POINTER_TYPE.TOUCHPAD && ptr.hitInfo.collider == GetComponent<Collider>())
			{
				SetControlState(CONTROL_STATE.OVER);
			}
			else
		...
		if (ptr.evt == whenToInvoke && soundOnClick != null && soundOnClick.isActiveAndEnabled)
		{
