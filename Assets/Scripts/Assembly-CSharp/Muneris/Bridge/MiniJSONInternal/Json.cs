...
namespace Muneris.Bridge.MiniJSONInternal
{
	public static class Json
	{
		private sealed class Parser : IDisposable
		{
			...
			private Dictionary<object, object> ParseObject()
			{
		...
		private sealed class Serializer
		{
			...
			private void SerializeValue(object value)
			{
				...
				{
					SerializeDictionary(obj);
				}
				else if ((bridgeObject = value as BridgeObject) != null)
				{
					SerializeBridgeObject(bridgeObject);
				}
			...
			private void SerializeBridgeObject(BridgeObject bridgeObject)
			{
				builder.Append('{');
				builder.Append("\"id\":");
				SerializeOther(bridgeObject.GetObjectId());
				builder.Append(",");
				builder.Append("\"class\":");
				SerializeString(bridgeObject.GetNativeClassName());
				builder.Append('}');
			}
